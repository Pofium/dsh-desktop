...
export const ru: Record<ModelsKey, string> = {
  ...
  keyEnvLocked: 'Предоставлено переменными окружения (только для чтения)',
  ...
  modelAdvanced: 'Лимиты и возможности',
  addModel: 'Добавить модель',
  removeModel: 'Удалить модель',
  modelsEmpty: 'В селекторе не будут отображаться модели. Не указанные ID всё ещё можно отправлять напрямую.',
  ...
  keyIllegalCharacters: 'API-ключ имеет неверный формат. Проверьте правильность ввода.',
  ...
  modelContextInvalid: 'Размер контекстного окна должен быть положительным числом, например 131072, 256K или 1M.',
  modelMaxTokensInvalid: 'Максимальное количество токенов должно быть положительным числом, например 8192, 64K или 1M.',
  advancedHint: 'Другие параметры находятся в settings.yaml; редактируйте этот раздел напрямую.',
  modelCapacityInvalid: 'Значение должно быть числом с возможным суффиксом K или M.',
  ...
  fetchDescription: 'Список моделей, доступных у этого провайдера. Выберите нужные.',
  ...
  customRouteHint: 'Идентификатор строчными буквами, начинающийся с буквы, уникально определяющий провайдера в запросах.',
  ...
  customNeedsBaseUrl: 'Для своего провайдера необходим базовый URL.',
  customNeedsModels: 'Для своего провайдера необходима хотя бы одна модель.',
  customBaseUrlPlaceholder: 'https://gateway.example/v1',
  settingsPathUnresolvable: 'не удалось определить путь к настройкам',
  create: 'Создать задачу',
  creating: 'Создание…',
  welcomeTitle: 'Уведомление о тестировании',
  welcomeBody: 'DeepSeek Harness 0.1 находится на стадии тестирования для разработчиков Harness. Мы будем рады обратной связи от сообщества разработчиков.\n\nМы стремимся исследовать границы интеллекта вместе с разработчиками со всего мира на базе открытой, расширяемой и компонуемой инфраструктуры.',
  ...
  onboardingDescription: 'Настройте официального провайдера DeepSeek для начала создания задач.',
