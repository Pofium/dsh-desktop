...
export const ru: Record<SubagentKey, string> = {
  ...
  'retry': 'Повторить',
  'mode.oneShot': 'однократный',
  'mode.continuable': 'продолжаемый',
  'activity.running': 'выполняется',
  'activity.inactive': 'не выполняется',
  'branch.collapse': 'Свернуть дочерние элементы {label}',
  'branch.expand': 'Развернуть дочерние элементы {label}',
  ...
  'readonly.oneShot.title': 'Запись однократного субагента',
  'readonly.title': 'Этот субагент сейчас доступен только для чтения',
  'readonly.oneShot.body': 'Однократные задачи не принимают продолжения. Вы можете просмотреть историю выполнения.',
  'readonly.body': 'Родительская сессия офлайн. Откройте её для продолжения отправки сообщений.',
}
