...
export const ru: Record<PluginsSettingsLocaleKey, string> = {
  ...
  saveFailed: 'Значения не были приняты и оставлены для исправления.',
  invalidNumber: 'Введите число или оставьте пустым для значения по умолчанию.',
  bashTitle: 'Терминал',
  bashDescription: 'Ограничения для каждой выполняемой команды агента.',
  bashTimeoutMs: 'Таймаут команды (мс)',
  bashTimeoutMsHint: 'Максимальное время выполнения одной команды до её завершения.',
  bashMaxOutputBytes: 'Лимит вывода на поток (байт)',
  bashMaxOutputBytesHint: 'Вывод сверх этого объёма сохраняется во временный файл.',
  agentLoopTitle: 'Цикл агента',
  agentLoopDescription: 'Управление вызовами инструментов агента.',
  agentLoopMaxParallel: 'Параллельные вызовы инструментов',
  agentLoopMaxParallelHint: 'Максимум параллельных безопасных вызовов в рамках одного шага.',
  webSearchTitle: 'Поиск в интернете',
  webSearchDescription: 'Провайдер поиска DeepSeek.',
  webSearchApiKey: 'API-ключ',
  webSearchApiKeyHint: 'Хранится вне файла настроек. Оставьте пустым для сохранения текущего ключа.',
  ...
  webSearchBaseUrlHint: 'Оставьте пустым для значения по умолчанию.',
  webSearchMaxUses: 'Макс. поисковых запросов на один запрос',
  webSearchMaxUsesHint: 'Сколько раз агент может выполнить поиск до формирования ответа.',
  ...
  subagentModelSelectionPartial: 'Некоторые провайдеры недоступны; сохранённые настройки можно удалить.',
  subagentModelSelectionUnavailable: 'В данный момент недоступно',
  subagentModelSelectionUnavailableGroup: 'Сохранено, но сейчас недоступно',
  subagentModelSelectionEmpty: 'Ни один провайдер не предоставляет моделей.',
  ...
  subagentModelSelectionOff: 'Субагенты используют настройки по умолчанию или наследуют модель родителя.',
}
