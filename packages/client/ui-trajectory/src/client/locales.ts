...
export const ru: Record<TrajectoryKey, string> = {
  ...
  'toolbar.useEqualWidth': 'Использовать равную ширину',
  'toolbar.actualTime': 'Реальное время',
  'toolbar.turns': 'Раунды',
  'toolbar.expandTurns': 'Развернуть все раунды',
  'toolbar.collapseTurns': 'Свернуть все раунды',
  ...
  'kind.subtool': 'SUBTOOL',
  'kind.sub': 'Подзадача',
  'column.input': 'Входные данные',
  'column.output': 'Выходные данные',
  'column.think': 'Размышления',
  'column.time': 'Время',
  'column.model': 'Модель',
  'column.tools': 'Инструменты',
  'turn.label': 'Раунд {turn}',
  'section.betweenTurns': 'Между раундами',
  ...
  'timing.ttft': 'TTFT (до 1-го токена)',
  ...
  'usage.input': 'Входные данные',
  'usage.cached': 'Кэшировано',
  'usage.cacheCreated': 'Записано в кэш',
  'usage.other': 'Другое',
  'usage.output': 'Выходные данные',
  ...
  'record.noPayload': 'Параметры не захвачены',
  'record.noResult': 'Результат не захвачен',
  ...
  'block.openSummary': 'Открыть сводку вызова инструмента для блока #{index}',
  ...
  'history.clickToLoadEarlier': 'Нажмите для загрузки более ранней истории',
  ...
  'details.resizeTitle': 'Потяните для изменения размера. Двойной клик для сброса.',
  ...
  'timeline.overviewAria': 'Обзор временной шкалы; перетаскивайте для фокусировки событий',
  'timeline.noTimingData': 'Нет данных о времени',
  'timeline.total': 'Всего {duration}',
  'timeline.started': 'Начало в {time}',
  'timeline.ttftDecoding': 'TTFT {ttft} · Декодирование {decoding}',
  'layout.compacting': 'Сжатие контекста…',
  'layout.compactionFailed': 'Ошибка сжатия контекста',
