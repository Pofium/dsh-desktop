...
export const ru = {
  ...
  'placeholder.workspace': 'Выберите рабочую область для начала',
  ...
  'attachment.dropBlocked': 'Добавление файлов и изображений сейчас недоступно',
  'file.attach': 'Прикрепить файл',
  'file.pending': 'Ожидающие отправки файлы',
  'file.remove': 'Удалить файл {name}',
  'file.uploading': 'Загрузка…',
  'file.uploadFailed': 'Не удалось загрузить, нажмите для повтора',
  'file.retry': 'Повторить загрузку {name}',
  'file.stillUploading': 'Файл ещё загружается — дождитесь завершения перед отправкой',
  'file.sessionUnavailable': 'Сессия недоступна, файл нельзя загрузить',
  'file.notStaged': 'Файл не был загружен — добавьте его заново',
  'file.label': 'Файл',
  ...
  'image.openOriginal': 'Просмотр оригинала',
  ...
  'image.tooMany': 'Сообщение может содержать не более {count} изображений',
  'image.fileTooLarge': 'Размер каждого изображения не должен превышать {size}',
  'image.totalTooLarge': 'Общий размер изображений превышает {size}; удалите часть файлов',
  'image.tooManyPixels': 'Слишком высокое разрешение; уменьшите изображение',
  'image.dimensionTooLarge': 'Размер сторон изображения не должен превышать {size}px',
  'image.modelUnsupported': 'Текущая модель не поддерживает изображения; переключите модель',
  ...
  'settings.enter.title': 'Действие по клавише Enter при занятости',
  'settings.enter.description': 'Только при занятости; Cmd/Ctrl+Enter использует альтернативное действие',
  'settings.enter.queue': 'В очередь',
  'settings.enter.steer': 'Вне очереди',
  ...
  'access.confirm.description': 'Полный доступ уменьшает количество подтверждений и позволяет агенту выполнять больше действий напрямую, включая чувствительные операции, изменение файлов и внешние команды. Используйте только для доверенных задач.',
  ...
  'tool.title.runCordis': 'Запуск плагина Cordis',
  'tool.title.stopCordis': 'Остановка плагина Cordis',
  'tool.title.removeCordis': 'Удаление плагина Cordis',
  'tool.title.pwsh': 'Pwsh',
  'tool.title.grep': 'Grep',
  'tool.title.glob': 'Glob',
  ...
  'queue.edit.unsupported': 'Содержит нетекстовый контент, редактирование недоступно',
  ...
  'queue.steer.unavailable': 'Отправка вне очереди доступна только во время выполнения',
  'queue.editFailed': 'Не удалось отредактировать: сообщение уже начало отправляться.',
  'queue.removeFailed': 'Не удалось удалить: сообщение уже начало отправляться.',
  'queue.steerFailed': 'Не удалось отправить вне очереди. Попробуйте снова.',
  ...
  'terminal.expandAria': 'Развернуть ещё {n} строк вывода',
