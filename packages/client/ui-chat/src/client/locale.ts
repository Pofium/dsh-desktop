...
export const ru = {
  ...
  'stats.tokensPerSecond': '{throughput} токенов/с',
  ...
  'details.empty': 'Нажмите на строку инструмента в потоке сообщений для просмотра деталей',
  'details.notInWindow': 'Этот вызов находится за пределами текущего окна',
  'details.input': 'Входные данные',
  'details.output': 'Выходные данные',
  ...
  'chat.toBottom': 'Вниз к последним сообщениям',
  ...
  'message.contextRecall': 'Контекст из других сессий',
  ...
  'message.retry.started': 'Запущен повтор запроса',
  ...
  'message.turnError': 'Ошибка выполнения этого раунда',
  'message.maxTokens': 'Достигнут лимит выходных токенов',
  'message.maxTokens.hint': 'Ответ был обрезан; предыдущий вывод сохранён в диалоге. Отправьте «продолжи», чтобы модель продолжила генерацию.',
  'message.ranFor': 'Время выполнения: {duration}',
  'message.tokensPerSecond': '{tps} токенов/с',
  'message.turnUsage.title': 'Использование в раунде',
  ...
  'message.turnUsage.output': 'Выходные токены',
  'message.turnUsage.reasoning': ' ({tokens} рассуждения)',
  'message.turnUsage.count': '{count} ток.',
  'message.turnTime.title': 'Время и скорость раунда',
  'message.turnTime.duration': 'Общее время работы',
