...
/** Russian copy. */
export const ru: Record<AgentPresetLocaleKey, string> = {
  error: 'error',
  userTrust: 'userTrust',
  seatHint: 'seatHint',
  ...
  view: 'view',
  presetStandardName: 'presetStandardName',
  presetStandardDescription: 'presetStandardDescription',
  presetPtcName: 'presetPtcName',
  presetPtcDescription: 'presetPtcDescription',
  presetMinimalName: 'presetMinimalName',
  presetMinimalDescription: 'presetMinimalDescription',
  presetCordisName: 'presetCordisName',
  presetCordisDescription: 'presetCordisDescription',
  duplicate: 'duplicate',
  duplicateUnavailable: 'duplicateUnavailable',
  delete: 'delete',
  presetId: 'presetId',
  presetIdPlaceholder: 'presetIdPlaceholder',
  ...
  brokenBadge: 'brokenBadge',
  brokenNoCopy: 'brokenNoCopy',
  switchRefused: 'switchRefused',
}
