...
export const ru: Record<AgentPresetSettingsKey, string> = {
  error: 'Ошибка',
  userTrust: 'Доверие пользователя',
  seatHint: 'Выберите пресет для этой сессии',
  headerHint: 'Управляет начальным набором инструментов и поведением агента',
  nav: 'Пресеты агента',
  sectionIntro: 'Пресеты определяют системный промпт, набор плагинов и инструментов агента.',
  builtIn: 'Встроенный',
  setDefault: 'По умолчанию',
  view: 'Просмотр',
  presetStandardName: 'Стандартный',
  presetStandardDescription: 'Полнофункциональный агент для разработки с доступом к файловой системе, терминалу и веб-поиску.',
  presetPtcName: 'Программное управление (PTC)',
  presetPtcDescription: 'Оптимизирован для автономного решения сложных задач через выполнение кода.',
  presetMinimalName: 'Минимальный',
  presetMinimalDescription: 'Базовый режим без дополнительных инструментов.',
  presetCordisName: 'Расширенный Cordis',
  presetCordisDescription: 'Пресет с поддержкой динамических плагинов Cordis.',
  duplicate: 'Дублировать',
  duplicateUnavailable: 'Дублирование недоступно',
  delete: 'Удалить',
  presetId: 'Идентификатор пресета',
  presetIdPlaceholder: 'my-custom-preset',
  displayName: 'Отображаемое имя',
  displayNamePlaceholder: 'Мой пресет',
  inUse: 'Используется',
  builtInGroup: 'Встроенные пресеты',
  customGroup: 'Пользовательские пресеты',
  noDescription: 'Без описания',
  brokenBadge: 'Повреждён',
  brokenNoCopy: 'Конфигурация пресета повреждена',
  ...
  copyIntro: 'Весь пресет будет скопирован на этом компьютере. Идентификатор станет именем папки и не сможет быть изменён позже; остальное редактируется в файлах пресета.',
  create: 'Создать задачу',
  creating: 'Создание…',
  creatorDraft: 'Создать пресет в режиме Creator',
  ...
  deleteDescription: 'Удаление {provider} удалит его конфигурацию. Учетные данные, управляемые в других местах, сохранятся.',
