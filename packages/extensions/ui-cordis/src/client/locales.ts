...
export const ru = {
  ...
  'panel.empty': 'Плагины пока не определены',
  ...
  'action.inspect': 'Инспектировать',
  'render.failedAbdicated': 'Ошибка рендеринга в {slot}; восстановлен интерфейс по умолчанию:',
  'render.failedHeld': 'Ошибка рендеринга в {slot}:',
